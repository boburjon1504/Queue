        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderEmailAddress = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ReceiverEmailAddress = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    Subject = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailHistories_EmailTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "EmailTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmailHistories_Users_ReceiverUserId",
                        column: x => x.ReceiverUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmailHistories_Users_SenderUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailHistories_ReceiverUserId",
                table: "EmailHistories",
                column: "ReceiverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EmailHistories_SenderUserId",
                table: "EmailHistories",
                column: "SenderUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EmailHistories_TemplateId",
                table: "EmailHistories",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_EmailTemplates_Type_TemplateType",
